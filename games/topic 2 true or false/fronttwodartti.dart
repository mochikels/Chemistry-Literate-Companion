// ignore_for_file: prefer_const_constructors, unnecessary_import, prefer_const_literals_to_create_immutables, unnecessary_new

import 'package:awesome_dialog/awesome_dialog.dart';
import 'package:chlic/games/topic%202%20true%20or%20false/quizscrntwo.dart';
import 'package:chlic/games/topic%202%20true%20or%20false/screentwodart.dart';
...
class QuizFirstPageEFD extends StatelessWidget {
  const QuizFirstPageEFD({super.key});
                  ...
                  onPressed: () {
                    AwesomeDialog(
                      ...
                      btnOkOnPress: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => QuizPagggeeeee(),
                        ),
                      ),
                    ).show();
